...
| intervention_user_names | Agents User names       | Array                                    | John Doe, Leo Major          | [Sensitive](../#sensitive-columns) |
| opened_intervention_user_names | Active agents User names | Array                            | John Doe, Leo Major          | [Sensitive](../#sensitive-columns) |
